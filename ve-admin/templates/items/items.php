	...
	<div class="form box animate">
		<div class="header">
			<div class="actions">
				...
				<div class="br3 publish hide"><?php echo $icons['publish']; ?><p class="views" title="<?php echo $lang['items_form_count_views']; ?>"></p></div>
				<div class="br3 save"><?php echo $lang['items_form_save']; ?></div>
				<div class="br3 save_close"><?php echo $lang['items_form_save_and_close']; ?></div>
				<div class="br3 close"><?php echo $lang['items_form_close']; ?></div>
			</div>
			<div class="title">{{title}}</div>
		</div>
		<div class="wrapper">
